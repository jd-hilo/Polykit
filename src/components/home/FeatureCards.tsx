...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    title: <>See what the sharpest wallets are doing — in real time.</>,
    sub2: <>Follow the top Polymarket traders and watch every trade they make, the moment they make it — <em>so you can decide whether to follow them in.</em></>,
    left: { h: "Track the smartest money", d: "Add any Polymarket wallet to your watchlist. We surface their open positions, recent trades, and overall P&L so you can spot the patterns before the crowd does.", cta: "Open Wallet Tracker", href: "/dashboard/wallet-tracker" },
    right: { h: "Get a live feed of every move", d: "Every buy, sell, and reposition from the wallets you follow streams into your dashboard. No more checking Polymarket every five minutes — the alpha comes to you.", cta: "View Tracked Wallets", href: "/dashboard/wallet-tracker" },
  },
  {
    id: "paper",
