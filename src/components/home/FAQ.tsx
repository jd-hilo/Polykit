...
const ITEMS = [
  ...
  },
  {
    ...
    a: "Yes. Claude Desktop, Claude.ai, ChatGPT connectors, Cursor, OpenClaw, and any client that supports remote MCP with a Bearer token.",
  },
  {
  ...
  {
    q: "Is there a catch on the $1 offer?",
    a: "No. $1 for your first month, then $39/mo. Cancel anytime before renewal. Full access from day one.",
  },
  {
